...
const Map = compose(
  withProps({
    ...
    loadingElement: <div style={{ height: '650px', width: '100%' }} />,
    containerElement: <div className="content-main map" style={{ height: '650px', width: '100%' }} />,
    mapElement: <div style={{ height: '650px', width: '100%' }} />,
  }),
  withScriptjs,
  withGoogleMap
)(props => (
